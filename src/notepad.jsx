...
{
    return(
        <motion.div drag dragMomentum={false} initial={{scale:0.75}} animate={{scale:1}} exit={{ scale: 0.25, opacity:0 }} whileDrag={{boxShadow: "0px 0px 10px"}} className="window z-0 active:z-1">
